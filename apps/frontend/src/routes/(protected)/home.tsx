    ...
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.buttonGroup}>
          <Button
            className={cx(buttonSharedStyles.button, buttonSharedStyles.solid)}
          >
            Solid Button
          </Button>
          <Button
            className={cx(buttonSharedStyles.button, buttonSharedStyles.soft)}
          >
            Soft Button
          </Button>
          <Button
          ...
          <Button
            className={cx(buttonSharedStyles.button, buttonSharedStyles.ghost)}
          >
            Ghost Button
          </Button>
        </div>
